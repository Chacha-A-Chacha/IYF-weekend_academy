# Season 10: Practical Web Development Training
...
**Outcome:** Portfolio with 1 flagship project + 5 mini-projects, GitHub activity, deployed applications
...
*A full-stack community platform built progressively throughout the course*

Students will build a complete web application featuring:
- User profiles and authentication
- Posts/content creation
- Comments and interactions
- Search and filtering
- Responsive design
- Real-time features (stretch goal)
...
*Build your first deployed website*

### **Week 1: Your First Website**

#### **Lesson 1: Web Development & Environment Setup**
**Learning Goals:**
- Understand how the web works (request/response cycle)
- Set up a professional development environment
- Deploy your first webpage within 90 minutes
...
4. **Deploy to GitHub Pages** before lesson ends
...
**Learning Goals:**
- Master semantic HTML for structure and accessibility
...
**Learning Goals:**
- Understand how CSS works (cascade, specificity, inheritance)
- Master the box model completely
- Style text and backgrounds professionally
...
### **Week 3: Command Line & Version Control**
...
**Hands-On Activities:**
1. Initialize repository for portfolio
2. Practice add, commit, push, pull workflow
...
**Milestone Checkpoint:** ✅ Deployed portfolio with Git version control
...
**Learning Goals:**
- Handle user events (clicks, inputs, keyboard)
...
**Milestone Checkpoint:** ✅ Weather app with API integration (deployed)

---

### **Week 7: JavaScript Projects & Best Practices**

#### **Lesson 13: Local Storage & State Management**
**Learning Goals:**
- Persist data using Local Storage
- Manage application state
- Structure larger JavaScript applications

**Hands-On Activities:**
1. Save and retrieve data from Local Storage
2. Build persistent to-do list
...
4. Code review session (peer review)
...
**Mini-Project:** Refactor all previous projects with best practices

---

## **PHASE 3: React & Modern Frontend (Weeks 8-9)**
*Framework skills built on solid vanilla JS foundation*
...
**Mini-Project:** Begin CommunityHub frontend (React conversion of portfolio)
...
- Fetch data in React applications
...
4. Build a complete page layout
...
**Mini-Project:** CommunityHub frontend with routing and styling

**Milestone Checkpoint:** ✅ React frontend with multiple pages (deployed)

---

## **PHASE 4: Backend Development (Weeks 10-11)**
*Building APIs that power your frontend*
...
**Mini-Project:** CommunityHub API (posts endpoint)
...
3. Implement database CRUD
4. Add data validation

**Resources:**
- [MDN: Express Database Integration](https://developer.mozilla.org/en-US/docs/Learn/Server-side/Express_Nodejs/mongoose)
...
**Mini-Project:** CommunityHub API with authentication

**Milestone Checkpoint:** ✅ Full CRUD API with authentication
...
4. Implement full CRUD in React
...
#### **Lesson 24: Deployment & Presentation**
**Learning Goals:**
...
4. Prepare and deliver project presentation
...
**Final Project:** CommunityHub - Deployed Full-Stack Application
...
### **Portfolio**
- 🎯 **CommunityHub:** Full-stack flagship project
- 📁 **5 Mini-Projects:** Portfolio site, to-do list, weather app, grade tracker, React components
...
1. **Coding Challenge** (15 min) - From daily challenge list
...
|------|------------|-------------|
| 3 | Foundation Complete | Deployed portfolio site |
| 6 | JavaScript Proficient | Weather app with API |
| 9 | Frontend Complete | React CommunityHub frontend |
| 12 | Full-Stack Ready | Deployed CommunityHub |
...
### **EXCLUDED (Future Learning)**
- ❌ Python/Flask (focus on one stack for mastery)
- ❌ TypeScript (learn JavaScript deeply first)
- ❌ Multiple frontend frameworks
- ❌ Advanced DevOps (Docker, Kubernetes)
- ❌ Testing frameworks (introduced conceptually)
...
- **Continued Learning:**
  ...
  - Python if second language desired
