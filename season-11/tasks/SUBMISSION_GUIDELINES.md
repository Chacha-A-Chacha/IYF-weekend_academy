# Submission Guidelines - Season 11
...
```
iyf-s11-week-{number}-{your-github-username}
```

**Examples:**
- `iyf-s11-week-01-MaisoriKitayama`
- `iyf-s11-week-05-MaisoriKitayama`

For team projects, use the team lead's username:
```
iyf-s11-week-{number}-team-{team-lead-username}
```
...
- **Format:** `https://github.com/MaisoriKitayama/iyf-s11-week-XX-MaisoriKitayama`
